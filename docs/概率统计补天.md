...
&ensp;&ensp;&ensp;&ensp;&ensp;特别地，$r=1$ 
...
&ensp;&ensp;&ensp;&ensp;&ensp;(5)样本联合分布：

$$ f(x_1,x_2,x_3,\cdots,x_n)=\Pi^n_{i=1}f(x_i)$$

<center>(分布函数同理) </center>
...
&ensp;&ensp;&ensp;&ensp;&ensp;(2)t分布
  ...
  &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;设$X$~$N(0,1)$,$Y$ ~ $\chi^2$(n),且X,Y相互独立，则随机变量
...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;$h(t)$的图形关于t=0对称，且有
