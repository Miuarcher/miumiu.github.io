...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;(3)$\frac{n_2\sigma^2_2\Sigma^{n_1}_{i=1}(X_i-\mu_1)^2}{n_1\sigma^2_1\Sigma^{n_1}_{i=1}(Y_i-\mu_2)^2}$~$F(n_1,n_2)$  

&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;(4)$\frac{\sigma^2_2S_1^2}{\sigma_1^2S_2^2}$~$F(n-1,m-1)$
